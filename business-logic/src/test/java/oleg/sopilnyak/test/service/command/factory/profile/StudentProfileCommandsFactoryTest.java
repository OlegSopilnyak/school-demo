...
class StudentProfileCommandsFactoryTest<T> {
    @Mock
    StudentProfileCommand<T> command1;
    @Mock
    StudentProfileCommand<T> command2;
    @Mock
    StudentProfileCommand<T> command3;

    StudentProfileCommandsFactory<T> factory;
