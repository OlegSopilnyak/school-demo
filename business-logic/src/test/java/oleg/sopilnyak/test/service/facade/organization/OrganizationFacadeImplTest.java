...
class OrganizationFacadeImplTest<T> {
    ...
    void shouldFindAllAuthorityPersons() {
        String commandId = AuthorityPersonCommands.FIND_ALL.id();
    ...
    void shouldNotGetAuthorityPersonById() {
        String commandId = AuthorityPersonCommands.FIND_BY_ID.id();
        Long id = 300L;
    ...
    void shouldCreateOrUpdateAuthorityPerson() {
        String commandId = AuthorityPersonCommands.CREATE_OR_UPDATE.id();
    ...
    void shouldFindAllFaculties() {
        String commandId = FacultyCommands.FIND_ALL.id();
    ...
    void shouldNotGetFacultyById() {
        String commandId = FacultyCommands.FIND_BY_ID.id();
        Long id = 400L;
    ...
    void shouldCreateOrUpdateFaculty() {
        String commandId = FacultyCommands.CREATE_OR_UPDATE.id();
    ...
    void shouldFindAllStudentsGroup() {
        String commandId = StudentsGroupCommands.FIND_ALL.id();
    ...
    void shouldGetStudentsGroupById() {
        String commandId = StudentsGroupCommands.FIND_BY_ID.id();
        Long id = 500L;
    ...
    void shouldCreateOrUpdateStudentsGroup() {
        String commandId = StudentsGroupCommands.CREATE_OR_UPDATE.id();
