...
class AuthorityPersonCommandsFactoryTest<T> {
    @Mock
    AuthorityPersonCommand<T> command1;
    @Mock
    AuthorityPersonCommand<T> command2;
    @Mock
    AuthorityPersonCommand<T> command3;

    AuthorityPersonCommandsFactory<T> factory;
