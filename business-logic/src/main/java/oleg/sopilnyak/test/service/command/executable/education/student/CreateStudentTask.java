...
public class CreateStudentTask extends SequentialMacroCommand<Optional<Student>>
    ...
    public Optional<Student> finalCommandResult(final Deque<Context<?>> contexts) {
        return contexts.stream().filter(CreateStudentTask::hasPerson)
     ...
     * @see Student
     * @see StudentCommand
     * @see CreateStudentTask#createPersonContext(StudentCommand, Student)
     * @see Context
     */
    @Override
     ...
     * @see CreateStudentTask#createProfileContext(StudentProfileCommand, Student)
     * @see Context
     */
    @Override
