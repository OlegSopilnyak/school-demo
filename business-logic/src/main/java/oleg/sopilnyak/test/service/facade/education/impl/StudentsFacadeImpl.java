...
public class StudentsFacadeImpl extends EducationFacadeImpl implements StudentsFacade, ActionFacade {
    ...
    public Set<Student> findEnrolledTo(Long id) {
        throw new UnsupportedOperationException("Deprecated method, use instead doActionAndResult(FIND_ENROLLED,...)");
    }
    ...
    public Set<Student> findNotEnrolled() {
        throw new UnsupportedOperationException("Deprecated method, use instead doActionAndResult(FIND_NOT_ENROLLED,...)");
    }
    ...
    public Optional<Student> create(Student instance) {
        throw new UnsupportedOperationException("Deprecated method, use instead doActionAndResult(CREATE_MACRO,...)");
    }
    ...
    public boolean delete(Long id) throws StudentNotFoundException, StudentWithCoursesException {
        throw new UnsupportedOperationException("Deprecated method, use instead doActionAndResult(DELETE_MACRO,...)");
    }
