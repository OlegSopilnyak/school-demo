...
public record BooleanResult(Boolean value) implements Output<Boolean> {
    ...
    static class Serializer extends StdSerializer<BooleanResult> {
        ...
        public void serialize(
                final BooleanResult result, final JsonGenerator generator, final SerializerProvider ignored
        ) throws IOException {
            generator.writeStartObject();
            generator.writeStringField(IOFieldNames.TYPE_FIELD_NAME, BooleanResult.class.getName());
            generator.writeBooleanField(IOFieldNames.VALUE_FIELD_NAME, result.value());
    ...
    static class Deserializer extends StdDeserializer<BooleanResult> {
        ...
        @Override
        public BooleanResult deserialize(
            ...
            return new BooleanResult(valueNode instanceof BooleanNode node ? node.booleanValue() : Boolean.FALSE);
        }
    }
}
