...
/**
 * Type: Command to execute the business-logic base action
 */
public interface SchoolCommand extends NestedCommand {
...
//        return visitor.prepareContext(asNestedCommand(), input);
//    }
//
//    /**
...
//        visitor.transferPreviousExecuteDoResult(asNestedCommand(), result, target);
//    }
//
//    /**
...
//        visitor.doNestedCommand(asNestedCommand(), context, stateListener);
//    }
//
//    /**
...
//        return visitor.undoNestedCommand(asNestedCommand(), context);
//    }
}
