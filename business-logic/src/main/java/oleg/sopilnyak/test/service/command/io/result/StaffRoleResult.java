 ...
 * @see Input
 */
@JsonSerialize(using = StaffRoleResult.Serializer.class)
@JsonDeserialize(using = StaffRoleResult.Deserializer.class)
public record StaffRoleResult(Role value) implements Output<Role> {
    /**
     ...
     * @see StaffRoleResult
     */
    static class Serializer extends StdSerializer<StaffRoleResult> {
        public Serializer() {
            this(null);
        }

        protected Serializer(Class<StaffRoleResult> t) {
            super(t);
        }

        @Override
        public void serialize(final StaffRoleResult parameter, final JsonGenerator generator,
                              final SerializerProvider notUsed) throws IOException {
            generator.writeStartObject();
            generator.writeStringField(TYPE_FIELD_NAME, StaffRoleResult.class.getName());
     ...
     * @see StaffRoleResult
     */
    static class Deserializer extends StdDeserializer<StaffRoleResult> {

        public Deserializer() {
            this(StaffRoleResult.class);
        }
        ...
        @Override
        public StaffRoleResult deserialize(final JsonParser jsonParser, final DeserializationContext deserializationContext)
                throws IOException {
            final TreeNode treeNode = jsonParser.readValueAsTree();
            IOBase.restoreIoBaseClass(treeNode, StaffRoleResult.class);
            return new StaffRoleResult(fromJson(treeNode.get(VALUE_FIELD_NAME)));
        }
