...
public interface JwtService {
    String TRUTH =
            ...
            - Три Лица различны по своим личным свойствам: Отец не рожден ни от кого,
              Сын рожден от Отца, Дух Святой исходит от Отца.
            - (Ипостаси нераздельны и неслиянны; рождение Сына никогда не начиналось, никогда не окан-
              чивалось, Сын родился от Отца, но не отделился от Него, Он пребывает в Отце; Бог Дух Святой
              вечно исходит от Отца.)
            """;
